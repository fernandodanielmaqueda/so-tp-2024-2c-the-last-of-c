...
const char *HEADER_NAMES[] = {
    ...
    [READ_REQUEST_HEADER] = "READ_REQUEST", //utilizado en MEMORIA-IO
    [WRITE_REQUEST_HEADER] = "WRITE_REQUEST", //utilizado en MEMORIA-IO
    [RESIZE_REQUEST_HEADER] = "RESIZE_REQUEST",
    [FRAME_ACCESS_HEADER] = "FRAME_ACCESS",    //PARA MEMORIA Y REVISAR LA TLB
    [FRAME_REQUEST_HEADER] = "FRAME_REQUEST",
    [PAGE_SIZE_REQUEST_HEADER] = "PAGE_SIZE_REQUEST",
    //IO <==> Memoria
    [IO_FS_WRITE_MEMORY_HEADER] = "IO_FS_WRITE_MEMORY",
    [IO_FS_READ_MEMORY_HEADER] = "IO_FS_READ_MEMORY",
    [IO_STDIN_WRITE_MEMORY_HEADER] = "IO_STDIN_WRITE_MEMORY",
    [IO_STDOUT_READ_MEMORY_HEADER] = "IO_STDOUT_READ_MEMORY"
};
